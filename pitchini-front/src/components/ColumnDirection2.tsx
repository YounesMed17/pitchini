...
export type ColumnDirection2Type = {
  /** Action props */
  onMaskGroupIcon2Click?: () => void;
};

const ColumnDirection2: FunctionComponent<ColumnDirection2Type> = ({
  onMaskGroupIcon2Click,
}) => {
  return (
...
export default ColumnDirection2;
